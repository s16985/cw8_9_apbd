...
namespace LinqConsoleApp
{
    public partial class LinqSamples
    {
        ...
        */
        ...
        {
            var res = Emps.Where(emp => emp.Salary == (Emps.Max(emp1 => emp1.Salary))).ToList();
        ...
        {
            var res = Emps.Contains(Emps.Where(emp => emp.Job == "Backend programmer").First());
        }
        ...
        public void Przyklad10Button_Click()
        {
            ...
            var result = (from s in Emps
                          select new { s.Ename, s.Job, s.HireDate }).Union(val).ToList();
        }
        ...
        {
            var res = Emps.Select(emp => emp)
            .Aggregate((result, next) => ((next.Salary > result.Salary) ? result = next : result));
        }
        ...
        {
            var res = Emps.SelectMany(emp => Emps, (emp, emp1) => new
            {
                emp,
                emp1
            });
